...
export default function BalisticCalculatorList() {
  const data = []

  const columns = [
    { accessorKey: 'date', header: 'Tanggal' },
    { accessorKey: 'location', header: 'Lokasi TKP' },
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 mb-4">
        <h2 className="text-xl font-bold">Calculator Balistik</h2>
        <div className="flex gap-2">
          <input type="date" className="px-2 py-1 border rounded text-sm" />
          <Link to="/balistic-calculator/create">
